/*
    File ciodemoc_.c: A sample C program to illustrate the use of some of
    ...
    to compile C programs, then the command:
      ...
      cc ciodemoc_.c -L/myhome/aires/lib -lAires
    ...
    "ciodemoc_.c" and invoke the C compiler to obtain the corresponding
    ...
    */
    {
       ...
       int       nciorec, nshowers, npart, nbeg, ntrail;
       ...
       int       crofileversion_(), thisairesversion_();    /*__*/
       int       getcrorecord_();                           /*__*/
       int       ciorinit_(), ciorshutdown_();              /*__*/
	 ...
	 /* Opening the cio input file. It will be labelled in variable
       ...
       */
       ...
       fileversion = crofileversion_(&ciochann);
       libversion  = thisairesversion_();
       ...
       while(getcrorecord_(&ciochann, &indata[1], &fldata[1],
                           &altrec, &i5, &irc))                /*__*/
       {
       ...
       printf(" Number of particle records : %d\n", npart);
       printf(" Number of head records     : %d\n", nbeg);
