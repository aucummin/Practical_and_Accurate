c
c
c        This file is part of the package IGRF10 to calculate the
c        Geomagnetic field values from a spherical harmonic model.
c
c        The IGRF10 package is distributed by the International
c        Association of Geomagnetism & Aeronomy.
c        (see www.ngdc.noaa.gov/IAGA/vmod)
c
c        The software here included contains only the routine
c        igrf10syn that evaluates the components of the geomagnetic
c        field at a given date and location.
c
c        Adapted by S. J. Sciutto, La Plata 2005.
c
c
c***************************************************************************
c
