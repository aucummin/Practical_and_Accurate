c
c     FILE: cioship1s.f                     Creation date: 11/AUG/1997.
...
c       It is assumed that the current depth of the particle
c       (fpdata(ixdepth)) is less than or equal to the ground depth
c       (groundepth). Notice that tmp1 is negative for particles going
c       downwards.
