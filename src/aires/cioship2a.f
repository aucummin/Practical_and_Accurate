c
c     FILE: cioship2a.f                     Creation date: 14/JUL/1997.
...
c
c           The time is shifted to obtain delay time with respect to the
c           corresponding observing level.
c
