c
c     FILE: cioship2xl.f                    Creation date: 14/JUL/1997.
...
c
      ...
      double precision  xfi, yfi, tfi, elog
      double precision  xfa, yfa, rfa
      double precision  rmaxfilel, pr00
      logical           saveinfile
      integer           ipdata(14)
      double precision  rpdata(14)
...
c
c           Logarithm of the energy at the first level crossed.
c
            elog = log(opbufffaux(1, i, cofile))
c
...
c
            ...
            rpdata(6) = xfi
            rpdata(7) = yfi
            rpdata(8) = fopbuff(ixcdepth , i, cofile)
            rpdata(9) = fopbuff(ixlhdepth, i, cofile)
c
