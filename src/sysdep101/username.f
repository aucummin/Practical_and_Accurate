...
c                                       LAST MODIFICATION: 03/MAY/1997.
c
...
c
      ...
      call system('echo $LOGNAME  >  .Aires_uhnam_TMP')
      call system('echo $HOSTNAME >> .Aires_uhnam_TMP')
...
c     User name.
c
      read(57, 2010, end = 3010, err = 3010) user
c
