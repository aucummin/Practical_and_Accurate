c
c     FILE: username.f                      Creation date: 12/DEC/1996.
...
c
c     Current username and hostname (HP and SUN Fortran version, and
c     also valid version for some IBM Fortran compilers).
c
