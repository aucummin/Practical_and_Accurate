c
c     FILE: daticpu.f                       Creation date: 12/DEC/1996.
c                                       LAST MODIFICATION: 29/APR/1997.
c
c     Date, time and cputime routines. HP and SUN platforms version.
...
c
c     Calling the system dependent routines (HP and SUN Fortran, and
c     some times also IBM Fortran) that return date and time as a
c     sequence of integers.
c
      call idate(idati)
c
...
c     FIRST EXECUTABLE STATEMENT
c
c     System call (HP and SUN Fortran).
c
